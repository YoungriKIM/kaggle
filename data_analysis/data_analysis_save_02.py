...
df_train.drop(['PassengerId', 'Name','FirstName', 'SibSp', 'Parch', 'Fare', 'Ticket', 'Cabin'], axis=1, inplace=True)
df_test.drop(['PassengerId', 'Name', 'FirstName', 'SibSp', 'Parch', 'Fare', 'Ticket', 'Cabin'], axis=1, inplace=True)
...
df_train.to_csv('D:/kaggle/0427_train.csv', index=False)
df_test.to_csv('D:/kaggle/0427_test.csv', index=False)
